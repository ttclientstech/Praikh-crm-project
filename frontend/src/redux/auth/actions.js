  ...
  ({ loginData }) =>
    async (dispatch) => {
      ...
      if (data.success === true) {
        ...
        window.sessionStorage.setItem('auth', JSON.stringify(auth_state));
...
export const logout = () => async (dispatch) => {
  ...
  const result = window.sessionStorage.getItem('auth');
  ...
  window.sessionStorage.setItem('isLogout', JSON.stringify({ isLogout: true }));
  ...
  if (data.success === false) {
    ...
    window.sessionStorage.setItem('auth', JSON.stringify(auth_state));
    window.sessionStorage.setItem('settings', JSON.stringify(tmpSettings));
    window.sessionStorage.removeItem('isLogout');
    dispatch({
