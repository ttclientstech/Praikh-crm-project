...
const dashboardPath = 'src/modules/DashboardModule/index.jsx';
let content = fs.readFileSync(dashboardPath, 'utf8');

// 1. Add DatePicker to imports
if (!content.includes('DatePicker')) {
    content = content.replace('Table, Input, Form, message, Divider, Tabs } from \'antd\';', 'Table, Input, Form, message, Divider, Tabs, DatePicker } from \'antd\';');
}
...
console.log('SUCCESS DashboardModule');
